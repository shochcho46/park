...
--
-- Host: localhost:3306
-- Generation Time: Sep 30, 2025 at 05:22 PM
...
CREATE TABLE `accounts` (
  ...
  `number_ticket` int DEFAULT NULL,
...
INSERT INTO `accounts` (`id`, `category_id`, `number_ticket`, `ticket_price`, `totalAmount`, `type`, `note`, `created_at`, `updated_at`) VALUES
(1, 2, NULL, NULL, 7500, 2, 'jlkj kjl', '2025-09-29 15:48:35', '2025-09-29 16:13:31'),
(3, 2, NULL, NULL, 4000, 1, NULL, '2025-09-29 15:59:34', '2025-09-29 15:59:34'),
(4, 3, NULL, NULL, 5000, 2, NULL, '2025-09-29 16:03:48', '2025-09-29 16:03:48'),
(6, 4, 5000, 15, 75000, 1, NULL, '2025-09-30 10:03:52', '2025-09-30 10:03:52');
...
(1, 'Super Admin', 'admin@gmail.com', '01740303508', 1, '2024-12-31 14:16:04', '2024-12-31 14:16:04', '522189', '$2y$12$iMnM1aMcTHHaKFdCjjXJGuPQeBBYEq1NKAAOm7a8F1D4OZCru6gZ2', NULL, NULL, '2025-01-09 10:22:57');
...
(2, 'Denger Rolar Boat', 'denger-rolar-boat', 1, '2025-09-29 15:30:12', '2025-09-29 15:30:12'),
(3, 'Garden', 'garden', 1, '2025-09-29 15:58:22', '2025-09-29 15:58:22'),
(4, 'Electric Bullet Train', 'electric-bullet-train', 1, '2025-09-29 15:58:52', '2025-09-29 15:58:52');
...
('koyADUfgUKmkDp6TR2TfEseBNCk9Q1tSgd937kyN', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiWDgzMW1ZdEF0MnFVdjFiYktJZm82b0x2UHZMc2tOQWhOamZJVjc1diI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMCI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1759252887),
('Mq1lEZWmjAwyUKIxsuAP6OhDnhREpIHPpNxtolfz', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '', 1759250740);
...
(1, 'Laurel Noel', 'sidype@mailinator.com', '01568359528', 1, NULL, NULL, '647794', '$2y$12$cuQGZRraEoxS6WLa7XuReeyKoU1mNI/DmrjPxtmXbR9P1Kag87Mxq', NULL, '2025-01-09 10:16:06', '2025-01-09 11:20:19');
...
(1, 1, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-01-09 10:16:06', '2025-01-09 10:16:06');
...
--
ALTER TABLE `accounts`
  ADD CONSTRAINT `accounts_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE;
