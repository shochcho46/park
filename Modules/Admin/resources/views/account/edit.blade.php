                    ...
                    <form action="{{route('admin.account.update',$data->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="type" id="type_income" value="1" {{ old('type', $data->type) == '1' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="type_income">
                                                    Income
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="type" id="type_expense" value="2" {{ old('type', $data->type) == '2' ? 'checked' : '' }}>
                            ...
                            <div class="row" id="ticket_fields">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="number_ticket" name="number_ticket" placeholder="0" value="{{ old('number_ticket', $data->number_ticket) }}" min="0" step="1">
                                        @error('number_ticket')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="ticket_price" name="ticket_price" placeholder="0.00" value="{{ old('ticket_price', $data->ticket_price) }}" min="0" step="0.01">
                                        @error('ticket_price')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="totalAmount" name="totalAmount" placeholder="0.00" value="{{ old('totalAmount', $data->totalAmount) }}" step="0.01" required>
                            ...
                            <div class="mb-3">
                                ...
                                @if($data->getFirstMediaUrl('account_docs'))
                                    <div class="mt-2">
                                        <small class="text-success">Current file:
                                            <a href="{{ $data->getFirstMediaUrl('account_docs') }}" target="_blank" class="text-primary">
                                                {{ $data->getFirstMedia('account_docs')->name ?? 'Download' }}
                                            </a>
                                        </small>
                                    </div>
                                @endif
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="note" name="note" rows="3" placeholder="Enter additional notes...">{{ old('note', $data->note) }}</textarea>
                                @error('note')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
